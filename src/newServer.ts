...
import { lengthDirectiveTransformer } from './directives/lengthDirective.js';
...
async function createSchema() {
  ...
  const graphqlSchema = lengthDirectiveTransformer(
    upperDirectiveTransformer(await neoSchema.getSchema()),
  );
